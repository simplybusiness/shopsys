    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builderSettingsGroup
            ->add('termsAndConditionsArticle', ChoiceType::class, [
                ...
                'icon_label' => t('Choose article, which will serve as terms and conditions with which the customer has to agree when creating order.'),
            ])
            ->add('privacyPolicyArticle', ChoiceType::class, [
                ...
                'icon_label' => t('Choose article, which will serve as privacy policy with which the customer has to agree when creating order or registering user.'),
            ]);
