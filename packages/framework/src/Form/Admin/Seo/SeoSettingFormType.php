    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builderSettingsGroup
            ...
            ->add('titleAddOn', TextType::class, [
                ...
                'icon_label' => 'Complement to title will be set as suffix to all titles e.g. if complement is set “ | My shop” and product name is “iPhone S7” the result title for this products page will be “iPhone S7 | My shop”.',
            ])
