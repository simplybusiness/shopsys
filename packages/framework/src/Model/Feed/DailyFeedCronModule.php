...
class DailyFeedCronModule implements IteratedCronModuleInterface
{
    ...
    /**
     * @var \Shopsys\FrameworkBundle\Model\Feed\FeedExportDataQueue|null
     */
    private $feedExportDataQueue;
    ...
    public function __construct(FeedFacade $feedFacade, Domain $domain, Setting $setting)
    {
        ...
        $this->feedExportDataQueue = new FeedExportDataQueue(
    ...
    {
        if ($this->feedExportDataQueue->isEmpty()) {
        ...
        if ($this->currentFeedExport->isFinished()) {
            ...
            return $this->feedExportDataQueue->next();
        }
    ...
    {
        $currentFeedName = $this->feedExportDataQueue->getCurrentFeedName();
        $currentDomain = $this->feedExportDataQueue->getCurrentDomain();
    ...
    public function wakeUp(): void
    {
        ...
        if ($feedNameToContinue !== null && $domainIdToContinue !== null) {
            $queue = $this->feedExportDataQueue;
        ...
        $this->logger->addDebug(sprintf(
            ...
            $this->feedExportDataQueue->getCurrentFeedName(),
            $this->feedExportDataQueue->getCurrentDomain()->getName(),
    ...
    private function createCurrentFeedExport(int $lastSeekId = null): FeedExport
    {
        return $this->feedFacade->createFeedExport(
            $this->feedExportDataQueue->getCurrentFeedName(),
            $this->feedExportDataQueue->getCurrentDomain(),
            $lastSeekId
        );
    }
}
