...
class UserDataFactory implements UserDataFactoryInterface
{
     ...
     * @return \Shopsys\FrameworkBundle\Model\Customer\UserData
     */
    public function createFromDomainId(int $domainId): UserData
    {
        $userData = new UserData();
        $this->fillFromDomainId($userData, $domainId);
     ...
     * @param int $domainId
     */
    protected function fillFromDomainId(UserData $userData, int $domainId)
    {
