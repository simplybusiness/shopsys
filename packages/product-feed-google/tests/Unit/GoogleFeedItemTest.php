...
class GoogleFeedItemTest extends TestCase
{
    ...
    /**
     * @var \Shopsys\ProductFeed\GoogleBundle\Model\Product\ProductUrlsProvider|\PHPUnit\Framework\MockObject\MockObject
     */
    private $productUrlsProviderMock;
    ...
    {
        $this->productUrlsProviderMock->method('getProductUrl')
            ->with($domain, $product)->willReturn($url);
    }
    ...
    {
        $this->productUrlsProviderMock->method('getProductImageUrl')
            ->with($domain, $product)->willReturn($url);
    }

    public function testMinimalGoogleFeedItemIsCreatable()
    {
        $googleFeedItem = $this->googleFeedItemFactory->create($this->defaultDomain, $this->defaultProduct);
    ...
    public function testGoogleFeedItemWithBrand()
    {
        ...
        /* @var \Shopsys\FrameworkBundle\Model\Product\Brand\Brand|\PHPUnit\Framework\MockObject\MockObject $product */
    ...
    public function testGoogleFeedItemWithSellingDenied()
    {
        ...
        $googleFeedItem = $this->googleFeedItemFactory->create($this->defaultDomain, $product);
